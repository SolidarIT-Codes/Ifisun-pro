        ...
        <div class="col-lg-12">
            ...
            <div class="panel panel-inverse" data-sortable-id="index-1">
                <div class="panel-heading">
                    <h4 class="panel-title">Details Information</h4>
                </div>
                <div class="panel-body">
                    ...
                    <p><strong>Numero de la Victime : </strong>   <?php echo $item['tel_vic']; ?></p>
                    <p><strong>Adresse de la Victime :</strong>   <?php echo $item['adresse_vic']; ?></p>
                    ...
                    if ($extension =='png'OR $extension =='PNG' OR $extension =='gif') {
                        echo "<img  width='600' height='600' src='http://localhost/ifi/uploads/images/".$item['preuve']."'

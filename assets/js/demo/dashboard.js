...
var handleInteractiveChart = function () {
	...
	if ($('#interactive-chart').length !== 0) {
		...
		var data4 = credit;
		var xLabel = [
            [1, ""], [2, ""], [3, "Mars&nbsp;"], [4, ""], [5, ""], [6, "Juin&nbsp;"], [7, ""], [8, ""], [9, "Sept&nbsp;"], [10, ""], [11, ""], [12, "Dec&nbsp;"]
		];
...
var handleDonutChart = function () {
	...
	if ($('#donut-chart').length !== 0) {
		var donutData = [
			{ label: "Immobilirt",  data: nimmo, color: COLOR_PURPLE_DARKER},
			{ label: "Credit",  data: ncredit, color: COLOR_PURPLE},
			{ label: "Famille",  data: nfam, color: COLOR_PURPLE_LIGHTER},
			{ label: "Affaire",  data: naff, color: COLOR_BLUE},
		];
...
var handleDashboardGritterNotification = function() {
	$(window).on('load', function() {
		setTimeout(function() {
			$.gritter.add({
				title: 'Bienvenue sur GRSC Pro',
				text: 'Gestion des rendez-vous et de la satisfation client',
